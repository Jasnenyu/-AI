...
const VIDEO_MODELS = [
  // PPIO 模型
  { value: 'ppio/seedance-v3', label: '即梦视频 3.0', provider: 'ppio' },
  { value: 'ppio/kling-2.5-turbo', label: '可灵 2.5 Turbo', provider: 'ppio' },
  { value: 'ppio/kling-2.6-pro', label: '可灵 2.6 Pro', provider: 'ppio' },
  { value: 'ppio/kling-o1', label: '可灵 O1', provider: 'ppio' },
  { value: 'ppio/minimax-hailuo-2.3', label: '海螺 2.3', provider: 'ppio' },
  { value: 'ppio/minimax-hailuo-02', label: '海螺 02', provider: 'ppio' },
  { value: 'ppio/pixverse', label: 'PixVerse', provider: 'ppio' },
  { value: 'ppio/vidu', label: 'Vidu', provider: 'ppio' },
  { value: 'ppio/wan', label: '万相', provider: 'ppio' },
  // FAL 模型
  { value: 'fal/sora-2', label: 'Sora 2', provider: 'fal' },
  { value: 'fal/veo-3.1', label: 'Veo 3.1', provider: 'fal' },
  ...
  { value: 'fal/ltx-2', label: 'LTX-2', provider: 'fal' },
  { value: 'fal/minimax-hailuo-2.3', label: '海螺 2.3 (FAL)', provider: 'fal' },
  { value: 'fal/minimax-hailuo-02', label: '海螺 02 (FAL)', provider: 'fal' },
  { value: 'fal/pixverse-v5.5', label: 'PixVerse V5.5', provider: 'fal' },
  { value: 'fal/vidu-q2', label: 'Vidu Q2', provider: 'fal' },
  { value: 'fal/wan-25-preview', label: '万相 2.5', provider: 'fal' },
  // KIE 模型
  ...
  { value: 'kie/grok-imagine-video', label: 'Grok 视频', provider: 'kie' },
] as const;
