...
// 视频生成节点定义
const videoGenerationNodeDefinition: CanvasNodeDefinition<VideoGenerationNodeData> = {
  type: CANVAS_NODE_TYPES.videoGeneration,
  ...
  createDefaultData: () => ({
    displayName: DEFAULT_NODE_DISPLAY_NAME[CANVAS_NODE_TYPES.videoGeneration],
    prompt: '',
    model: 'ppio/seedance-v3',
    aspectRatio: '16:9',
    videoUrl: null,
    previewImageUrl: null,
    isGenerating: false,
...
export const canvasNodeDefinitions: Record<CanvasNodeType, CanvasNodeDefinition> = {
  ...
  [CANVAS_NODE_TYPES.videoGeneration]: videoGenerationNodeDefinition,
};
